...
pub fn draw_settings_icon(
    ...
    let Some(path) = Path::from_svg(SETTINGS_PATH) else {
        return;
    };
    painter.save();
    ...
    painter.translate(Vec2::new(-512.0, -512.0));
